...
public class MediaApplication {
    public static void main(String[] args) throws UnknownHostException {
        ...
        SpringApplication application = new SpringApplication(MediaApplication.class);
        ...
        System.out.println("(♥◠‿◠)ﾉﾞ  TSS-Media Run Successfully!   ლ(´ڡ`ლ)ﾞ  ");
        System.out.printf(
                "\n---------------------------------------------------------------------------------------\n\t" +
